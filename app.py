...
class Venue(db.Model):
    ...
    shows = db.relationship('Show', backref='shows_artist_list', lazy=True)
...
class Artist(db.Model):
    ...
    image_link = db.Column(db.String(500))
    facebook_link = db.Column(db.String(120))
    shows = db.relationship('Show', backref='shows_venue_list', lazy=True)
...
def create_venue_submission():
    ...
    try:
        ...
        venue = Venue(name=name, city=city, state=state, phone=phone, genres=genres, seeking_talent=seeking_talent, seeking_description=seeking_description, website=website, image_link=image_link, facebook_link=facebook_link)
...
def create_show_submission():
    ...
    #
    #
    # if artist_id is '' or Artist.query.get(artist_id) is None:
    #     flash('An error occurred. Artist doesn\'t exist')
    #     return render_template('pages/home.html')
    #
    # if venue_id is '' or Venue.query.get(venue_id) is None:
